...
! function(t) {
    ...
    function _t(n, i) {
        ...
        _.bindOptions(["locale", "monthNames", "monthNamesShort", "dayNames", "dayNamesShort", "firstDay", "weekNumberCalculation"], function(t, e, n, i, s, o, l) {
            ...
            var t;
            return "local" === _.options.timezone ? (t = qt.moment.apply(null, arguments), t.hasTime() && t.local()) : t = "America/Guayaquil" === _.options.timezone ? qt.moment.utc.apply(null, arguments) : qt.moment.parseZone.apply(null, arguments), r(t), t
        }, _.localizeMoment = r, _.getIsAmbigTimezone = function() {
            return "local" !== _.options.timezone && "America/Guayaquil" !== _.options.timezone
    ...
    De.mixin(ue), De.mixin({
        ...
        startParam: "start",
        endParam: "end",
        timezoneParam: "America/Guayaquil",
    ...
    qt.locale("es", De.englishDefaults), qt.sourceNormalizers = [], qt.sourceFetchers = [];
    var xe = {
            dataType: "json",
            cache: !1
        },
