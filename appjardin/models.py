...
class Profesor(models.Model):
    ...
    imagen = models.ImageField(max_length=100, upload_to='imagenprofesor',
                               verbose_name='Imagen')
    ...
    estado_civil = CharField(max_length=10, choices=MONTH_CHOICES,
                             verbose_name='Estado Civil')
    genero = CharField(max_length=10, choices=Genero_CHOICES,
                       verbose_name='Género')
